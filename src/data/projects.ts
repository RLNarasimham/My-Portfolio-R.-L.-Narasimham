...
export const projects: ProjectType[] = [
  {
    ...
    liveUrl: 'https://shopify-e-commerce-website-4rax.onrender.com',
  ...
  },
  {
    ...
    category: 'web',
    image: './Notemotion Web App.jpg',
    technologies: ['React', 'Javascript', 'Vite', 'Nodemon', 'Node JS', 'Express JS', 'Tailwind CSS', 'MongoDB', 'Axios', 'Lucide-react (for icons)'],
    liveUrl: 'https://frontend-assignment-primetrade-ai.vercel.app',
    githubUrl: 'https://github.com/RLNarasimham/Notemotion-Admin-Dashboard',
  },
  {
    id: 3,
    title: 'SHOWTIMEGO - Movie Ticket Booking Website',
    description: 'Built a responsive React + TypeScript app (Tailwind) with TMDB-powered movie listings and interactive seat selection. Implemented Node/Express backend (JWT-ready, MongoDB config) with Razorpay payment integration.',
    category: 'web',
    image: './SHOWTIMEGO Movie Ticket Booking app.jpg',
    technologies: ['Numpy', 'Matplotlib', 'Scikit Learn', 'Seaborn', 'Pickle'],
    liveUrl: 'https://movie-ticket-frontend.onrender.com',
